                    ...
                    <div class="row align-items-center position-relative">
                        ...
                        <div class="col-lg-3 col-md-4 col-6">
                            <div class="header-logo">
                                <a href="index.html"><img src="assets/images/logo/png-transparent-roast-chicken-barbecue-chicken-roasting-chicken-as-food-barbecue-barbecue-food-recipe.png" alt="Site Logo" /></a>
                            </div>
                        </div>
                        <!-- Header Logo End -->
            ...
            <div class="swiper-wrapper">
                ...
                <div class="hero-slide-item swiper-slide">
                    <div class="hero-slide-bg">
                        <img src="{{url('/images/images/gril-limon-kurica-myaso_1620634985.jpg')}}" alt="Slider Image" >
                ...
                <div class="hero-slide-item swiper-slide">
                    <div class="hero-slide-bg">
                        ...
                        <img src="{{url('/images/images/f78b8d9deaf4505b4700b543e405aebb_1620635212.jpg')}}" alt="Slider Image" >
                        
                       
                    </div>
                    <div class="container">
                        <div class="hero-slide-content text-center text-md-end">
                            <h5 class="sub-title" style="color:midnightblue">We keep pets for pleasure.</h5>
                            <h2 class="title m-0" style="color:midnightblue">Vitamins For all Pets</h2>
                            <p style="color:midnightblue">We know your concerns when you are looking for a chewing treat for your dog.</p>
                            <a href="shop.html" class="btn btn-dark btn-hover-primary" style="color:midnightblue">Shop Now</a>
                        </div>
                    </div>
                ...
                <div class="hero-slide-item swiper-slide">
                    <div class="hero-slide-bg">
                        ...
                        <img src="{{url('/images/images/tabaka_1620635176.jpg')}}" alt="Slider Image"  >
                ...
                <div class="hero-slide-item swiper-slide">
                    <div class="hero-slide-bg">
                        ...
                        <img src="{{url('/images/images/recipe_50162ca9-44e2-4dc8-9dee-62dad6adede7_1620636734.jpg')}}" alt="Slider Image" >
                       
                    </div>
                    <div class="container">
                        <div class="hero-slide-content text-center text-md-end">
                            <h5 class="sub-title" style="color:aqua">We keep pets for pleasure.</h5>
                            <h2 class="title m-0" style="color:aqua">Vitamins For all Pets</h2>
                            <p style="color:aqua">We know your concerns when you are looking for a chewing treat for your dog.</p>
                            <a href="shop.html" class="btn btn-dark btn-hover-primary" style="color:aqua">Shop Now</a>
                        </div>
                    </div>
            </div>
